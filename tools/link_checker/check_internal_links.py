...
def check_variant(variant: str, content_dir: Path, variant_pages: dict[str, set[str]],
    ...
    for route in sorted(pages):
        ...
        if source_rel.startswith((
            ...
            "api-reference/flytekit-sdk",  # v1 equivalent of flyte-sdk
            "api-reference/union-sdk",  # v1 SDK doc
            "api-reference/flytectl-cli",  # v1 equivalent of flyte-cli
            "api-reference/pyflyte-cli",  # v1 CLI doc
            "api-reference/union-cli",  # v1 CLI doc
        )):
            continue
