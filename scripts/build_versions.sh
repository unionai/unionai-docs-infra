...
# and a <page>.md twin / _section.md beside every page. Those were fully indexable:
...
if [ "$DRY_RUN" != 1 ] && [ -n "$NOINDEX_LABELS" ]; then
  { echo ""
    ...
    echo "# robots tag covers HTML; this covers llms.txt, sitemap.xml, the .md twins, etc."
